...
class Public_model extends CI_Model
{
    ...
    public function getPosts($limit, $page, $search = null, $month = null)
    {
        ...
        $this->db->join('blog_translations', 'blog_translations.for_id = blog_posts.id', 'left');
        $this->db->where('blog_translations.abbr', MY_LANGUAGE_ABBR);
        $query = $this->db->select('blog_posts.id, blog_translations.title, blog_translations.description, blog_posts.url, blog_posts.year_published, blog_posts.time, blog_posts.image')->get('blog_posts', $limit, $page);
        return $query->result_array();
    }
    ...
    public function getPost_id($url)
    {
        $this->db->select('*');
