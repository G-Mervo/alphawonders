...
class Dashboard extends BaseController
{
    ...
    public function services()
    {
        ...
        $data['services'] = [
            ...
            ['name' => 'SEO', 'icon' => 'fa-magnifying-glass', 'route' => 'seo', 'color' => 'info', 'desc' => 'Search engine optimisation, Google ranking, organic traffic', 'status' => 'active', 'view' => 'alphamarketing'],
    ...
    public function servicePreview(string $viewName)
    {
        ...
        $serviceCategoryMap = [
            ...
            'alphamarketing'   => ['slugs' => ['seo', 'digital-marketing', 'marketing', 'search-engine-optimisation'], 'primary' => 'seo'],
