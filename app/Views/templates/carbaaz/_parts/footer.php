<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            // we're in the beta phase where the website is still being upgraded and tested and some functionalities have been disabled. Check back soon for something really marvellous and amazing 
