...
.vote-btn {
  ...
  .icon {
    ...
    background:$red url(https://alphawonders.com/codepen/img/checkmark.svg) no-repeat 2px 1px;
...
.container{
	background:rgba(0,0,0,.4) url(http://alphawonders.com/raffle/images/metal.jpg) 50% 50% no-repeat;
...
.roller{
	...
	background:url(http://alphawonders.com/raffle/images/purple.jpg);
}
.page-header {
...
td:nth-child(even) .roller{
	background:url(http://alphawonders.com/raffle/images/blue.jpg);
}
	...
	<div class="col-lg-9 sld">
			...
			<div class="row text-center">
				<div class="col-md-4 col-md-offset-3">
					...
					<div id="msgbox"class="alert alert-warning" style="margin-top:20px;display:none;">There are 6 positions available! And every member needs to play only once to get assigned a number.</div>
				</div>
			</div>
			...
			<div class="row text-center" id="bdl" style="background: #1f201f; padding: 7px">
				<div class="row">
					<div class="col-md-9 col-md-offset-3">
						<textarea class="form-control inputbox" rows="7"></textarea>
					</div>
					<div class="col-md-9 col-md-offset-3">
						<div class="col-lg-1 vpst" id="v-pst-1">1</div>
						<div class="col-lg-1 vpst" id="v-pst-2">2</div>
						<div class="col-lg-1 vpst" id="v-pst-3">3</div>
						<div class="col-lg-1 vpst" id="v-pst-4">4</div>
						<div class="col-lg-1 vpst" id="v-pst-5">5</div>
						<div class="col-lg-1 vpst" id="v-pst-6">6</div>
					</div>
				</div>				
				<div class="row">
					<div class="col-lg-12">
		...
		$( "#loadout" ).animate({
			...
			$('#loadout').children('td').each(function () {
				...
				if($(this).offset().left < center && $(this).offset().left + 185 > center){
					...
					console.log(text); 
					$("#log").append("Your position is<br/> <span class=\"badge\">"+text+"</span>");
					
					// store the position value
					$.ajax({
				                url: '<?php echo base_url('vvc/voting/save') ?>',
				                type: 'post',
				                data: {row:text},
