...
<h1><img src="<?= base_url('assets/imgs/blogger.png') ?>" class="header-img img-responsive" style="margin-top:-2px;"> Publish post</h1>
<hr>
<div class="row">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            foreach ($languages as $language) {
                ...
                <div class="form-group">
                    ...
                    <textarea name="description[]" id="description<?= $i ?>" rows="50" class="form-control" required><?= $trans_load != null && isset($trans_load[$language->abbr]['description']) ? $trans_load[$language->abbr]['description'] : '' ?></textarea>
                    <script>
