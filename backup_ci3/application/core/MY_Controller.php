...
class MY_Controller extends MX_Controller
{
    ...
    public function render($view, $head, $data = null, $footer = null, $page = 0)
    {
        ...
        function buildTree2(array $elements, $parentId = 0)
        {
            ...
            foreach ($elements as $element) {
                if ($element['sub_for'] == $parentId) {
                    $children = buildTree2($elements, $element['id']);
                    if ($children) {
                        $element['children'] = $children;
                    }
                    $branch[] = $element;
        ...
        $head['home_categories'] = $tree =buildTree2($all_categories);
